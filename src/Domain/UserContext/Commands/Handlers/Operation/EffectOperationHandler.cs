...
public sealed class EffectOperationHandler : Handler<EffectOperationCommand, EffectOperationCommandResult>
{
    private readonly IOperationRepository _operationRepository;
    private readonly IUserRepository _userRepository;
    private readonly IUow _uow;
    private readonly EffectOperationCommandResult _commandResult;

    public EffectOperationHandler(
    ...
    public override Task<EffectOperationCommandResult> Handle(EffectOperationCommand command, CancellationToken ct)
    {
        if (!command.Validate())
        {
